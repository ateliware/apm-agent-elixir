defmodule ElasticAPM.Context do
  @moduledoc """
  ...
  def add(key, value) do
    case ElasticAPM.Internal.Context.new(:extra, key, value) do
      {:error, _} = err ->
        err

      {:ok, context} ->
        ElasticAPM.TrackedRequest.record_context(context)
        :ok
    end
  end
  ...
  def add_user(key, value) do
    case ElasticAPM.Internal.Context.new(:user, key, value) do
      {:error, _} = err ->
        err
